...
class CreateUSDLayersOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        try:
            ...
            # Prepare the USD exporter setup
            ...
            properties = {
                ...
                "filepath": os.path.splitext(bpy.data.filepath)[0] + ".usd",
                "root_prim_path": bpy.context.scene.name
            }
            bpy.ops.wm.usd_export(override, **properties)
